...
/**
 * Side sheet built on the same Radix Dialog primitive as `Dialog` (focus trap,
 * Escape, backdrop click for free) — the accessible replacement for the
 * hand-rolled mobile nav drawer (`collapsible-sidebar.tsx`), which had Escape
 * wired manually but no focus trap.
 */
...
const drawerVariants = cva(
  "fixed z-50 flex flex-col gap-4 border bg-card p-5 shadow-elevation-floating data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 max-h-[85dvh] rounded-t-panel border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
      },
    },
