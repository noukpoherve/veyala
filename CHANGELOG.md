...
* **analytics:** load GA4 in production after cookie consent ([02eb79b](https://github.com/noukpoherve/veyala/commit/02eb79b6c2ffa0e00d4e48c9d10a2ac8dc84e940))
...
This file is maintained by [semantic-release](https://github.com/semantic-release/semantic-release) on every merge to `main`. Release history is also published under **GitHub → Releases**.
