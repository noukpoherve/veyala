// Adaptation du CV à une offre d'emploi via l'API Claude.
...
/**
 * Appelle Claude pour adapter le CV à l'offre.
 * Retourne { headline, profil, competences, experiences } prêt pour buildCvDocx.
 */
...
${criteria ? "CONSIGNES SUPPLÉMENTAIRES DU CANDIDAT : " + criteria : ""}`;
  ...
  // Garde-fous : structure minimale + retour aux valeurs de base si absent.
  return {
    info: BASE_INFO,
