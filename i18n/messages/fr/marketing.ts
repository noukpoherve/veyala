export const marketing = {
  ...
  carouselPrev: "Templates précédents",
  carouselNext: "Templates suivants",
  templateNameAcademic: "Académique",
  templateTagPopular: "Populaire",
  templateTagNew: "Nouveau",
  heroAtsScore: "Score ATS",
  heroTagJob: "Emploi",
  heroTagOptimized: "Optimisé",
  heroAiWorking: "IA en cours",
  heroGenerating: "Génération...",
